...
// Vendored from React Bits (reactbits.dev) via Agentry's web/components/WebThreads.jsx
// — same provenance note Agentry's own copy carries: verbatim upstream component,
// only added "use client" for the Next.js App Router. Ported to .tsx here (typed
// props) since this project is TypeScript throughout; the WebGL/shader logic is
// unchanged. Colors are passed as props — see AgentVision.tsx for Vault402's palette.
...
const ctxMap = new WeakMap<HTMLDivElement, ProgramCtx>();
